...
"""Select metrics to measure the loss and the accuracy of the model. These metrics accumulate
 the values over epochs and then print the overall result."""
...
[TensorFlow tutorials](https://www.tensorflow.org/alpha/tutorials/keras)."""
